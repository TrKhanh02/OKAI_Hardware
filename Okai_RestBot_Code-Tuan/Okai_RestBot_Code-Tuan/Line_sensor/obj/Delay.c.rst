      ...
      00042D                        575 _Timer0_Delay100us:
                           ...
                           000001   582 	ar1 = 0x01
                           000000   583 	ar0 = 0x00
      00042D AC 82            [24]  584 	mov	r4,dpl
      00042F AD 83            [24]  585 	mov	r5,dph
      000431 AE F0            [24]  586 	mov	r6,b
      000433 FF               [12]  587 	mov	r7,a
                                    588 ;	lib/Delay.c:24: clr_T0M;                                		//T0M=0, Timer0 Clock = Fsys/12
      000434 53 8E F7         [24]  589 	anl	_CKCON,#0xf7
                                    590 ;	lib/Delay.c:25: TMOD |= 0x01;                         		  //Timer0 is 16-bit mode
      000437 43 89 01         [24]  591 	orl	_TMOD,#0x01
                                    592 ;	lib/Delay.c:26: set_TR0;                            		    //Start Timer0
                                    593 ;	assignBit
      00043A D2 8C            [12]  594 	setb	_TR0
                                    595 ;	lib/Delay.c:27: while (u32CNT != 0)
      00043C                        596 00104$:
      00043C EC               [12]  597 	mov	a,r4
      00043D 4D               [12]  598 	orl	a,r5
      00043E 4E               [12]  599 	orl	a,r6
      00043F 4F               [12]  600 	orl	a,r7
      000440 60 1A            [24]  601 	jz	00106$
                                    602 ;	lib/Delay.c:29: TL0 = LOBYTE(TIMER_DIV12_VALUE_100us);	//Find  define in "Function_define.h" "TIMER VALUE"
      000442 75 8A 7E         [24]  603 	mov	_TL0,#0x7e
                                    604 ;	lib/Delay.c:30: TH0 = HIBYTE(TIMER_DIV12_VALUE_100us);
      000445 75 8C FF         [24]  605 	mov	_TH0,#0xff
                                    606 ;	lib/Delay.c:31: while (TF0 != 1);       		            //Check Timer0 Time-Out Flag
      000448                        607 00101$:
                                    608 ;	lib/Delay.c:32: clr_TF0;
                                    609 ;	assignBit
      000448 10 8D 02         [24]  610 	jbc	_TF0,00135$
      00044B 80 FB            [24]  611 	sjmp	00101$
      00044D                        612 00135$:
                                    613 ;	lib/Delay.c:33: u32CNT --;
      00044D 1C               [12]  614 	dec	r4
      00044E BC FF 09         [24]  615 	cjne	r4,#0xff,00136$
      000451 1D               [12]  616 	dec	r5
      000452 BD FF 05         [24]  617 	cjne	r5,#0xff,00136$
      000455 1E               [12]  618 	dec	r6
      000456 BE FF 01         [24]  619 	cjne	r6,#0xff,00136$
      000459 1F               [12]  620 	dec	r7
      00045A                        621 00136$:
      00045A 80 E0            [24]  622 	sjmp	00104$
      00045C                        623 00106$:
                                    624 ;	lib/Delay.c:35: clr_TR0;                       			        //Stop Timer0
                                    625 ;	assignBit
      00045C C2 8C            [12]  626 	clr	_TR0
                                    627 ;	lib/Delay.c:36: }
      00045E 22               [24]  628 	ret
                                    629 ;------------------------------------------------------------
                                    ...
                                    637 ;	-----------------------------------------
      00045F                        638 _Timer0_Delay1ms:
      00045F AC 82            [24]  639 	mov	r4,dpl
      000461 AD 83            [24]  640 	mov	r5,dph
      000463 AE F0            [24]  641 	mov	r6,b
      000465 FF               [12]  642 	mov	r7,a
                                    643 ;	lib/Delay.c:40: clr_T0M;                                		//T0M=0, Timer0 Clock = Fsys/12
      000466 53 8E F7         [24]  644 	anl	_CKCON,#0xf7
                                    645 ;	lib/Delay.c:41: TMOD |= 0x01;                           		//Timer0 is 16-bit mode
      000469 43 89 01         [24]  646 	orl	_TMOD,#0x01
                                    647 ;	lib/Delay.c:42: set_TR0;                              		  //Start Timer0
                                    648 ;	assignBit
      00046C D2 8C            [12]  649 	setb	_TR0
                                    650 ;	lib/Delay.c:43: while (u32CNT != 0)
      00046E                        651 00104$:
      00046E EC               [12]  652 	mov	a,r4
      00046F 4D               [12]  653 	orl	a,r5
      000470 4E               [12]  654 	orl	a,r6
      000471 4F               [12]  655 	orl	a,r7
      000472 60 1A            [24]  656 	jz	00106$
                                    657 ;	lib/Delay.c:45: TL0 = LOBYTE(TIMER_DIV12_VALUE_1ms); 		//Find  define in "Function_define.h" "TIMER VALUE"
      000474 75 8A CA         [24]  658 	mov	_TL0,#0xca
                                    659 ;	lib/Delay.c:46: TH0 = HIBYTE(TIMER_DIV12_VALUE_1ms);
      000477 75 8C FA         [24]  660 	mov	_TH0,#0xfa
                                    661 ;	lib/Delay.c:47: while (TF0 != 1);                   		//Check Timer0 Time-Out Flag
      00047A                        662 00101$:
                                    663 ;	lib/Delay.c:48: clr_TF0;
                                    664 ;	assignBit
      00047A 10 8D 02         [24]  665 	jbc	_TF0,00135$
      00047D 80 FB            [24]  666 	sjmp	00101$
      00047F                        667 00135$:
                                    668 ;	lib/Delay.c:49: u32CNT --;
      00047F 1C               [12]  669 	dec	r4
      000480 BC FF 09         [24]  670 	cjne	r4,#0xff,00136$
      000483 1D               [12]  671 	dec	r5
      000484 BD FF 05         [24]  672 	cjne	r5,#0xff,00136$
      000487 1E               [12]  673 	dec	r6
      000488 BE FF 01         [24]  674 	cjne	r6,#0xff,00136$
      00048B 1F               [12]  675 	dec	r7
      00048C                        676 00136$:
      00048C 80 E0            [24]  677 	sjmp	00104$
      00048E                        678 00106$:
                                    679 ;	lib/Delay.c:51: clr_TR0;                              		  //Stop Timer0
                                    680 ;	assignBit
      00048E C2 8C            [12]  681 	clr	_TR0
                                    682 ;	lib/Delay.c:52: }
      000490 22               [24]  683 	ret
                                    684 ;------------------------------------------------------------
                                    ...
                                    692 ;	-----------------------------------------
      000491                        693 _Timer1_Delay10ms:
      000491 AC 82            [24]  694 	mov	r4,dpl
      000493 AD 83            [24]  695 	mov	r5,dph
      000495 AE F0            [24]  696 	mov	r6,b
      000497 FF               [12]  697 	mov	r7,a
                                    698 ;	lib/Delay.c:57: clr_T1M;																		//T1M=0, Timer1 Clock = Fsys/12
      000498 53 8E EF         [24]  699 	anl	_CKCON,#0xef
                                    700 ;	lib/Delay.c:58: TMOD |= 0x10;																//Timer1 is 16-bit mode
      00049B 43 89 10         [24]  701 	orl	_TMOD,#0x10
                                    702 ;	lib/Delay.c:59: set_TR1;																		//Start Timer1
                                    703 ;	assignBit
      00049E D2 8E            [12]  704 	setb	_TR1
                                    705 ;	lib/Delay.c:60: while (u32CNT != 0)
      0004A0                        706 00104$:
      0004A0 EC               [12]  707 	mov	a,r4
      0004A1 4D               [12]  708 	orl	a,r5
      0004A2 4E               [12]  709 	orl	a,r6
      0004A3 4F               [12]  710 	orl	a,r7
      0004A4 60 1A            [24]  711 	jz	00106$
                                    712 ;	lib/Delay.c:62: TL1 = LOBYTE(TIMER_DIV12_VALUE_10ms);		//Find  define in "Function_define.h" "TIMER VALUE"
      0004A6 75 8B EA         [24]  713 	mov	_TL1,#0xea
                                    714 ;	lib/Delay.c:63: TH1 = HIBYTE(TIMER_DIV12_VALUE_10ms);
      0004A9 75 8D CB         [24]  715 	mov	_TH1,#0xcb
                                    716 ;	lib/Delay.c:64: while (TF1 != 1);												//Check Timer1 Time-Out Flag
      0004AC                        717 00101$:
                                    718 ;	lib/Delay.c:65: clr_TF1;
                                    719 ;	assignBit
      0004AC 10 8F 02         [24]  720 	jbc	_TF1,00135$
      0004AF 80 FB            [24]  721 	sjmp	00101$
      0004B1                        722 00135$:
                                    723 ;	lib/Delay.c:66: u32CNT --;
      0004B1 1C               [12]  724 	dec	r4
      0004B2 BC FF 09         [24]  725 	cjne	r4,#0xff,00136$
      0004B5 1D               [12]  726 	dec	r5
      0004B6 BD FF 05         [24]  727 	cjne	r5,#0xff,00136$
      0004B9 1E               [12]  728 	dec	r6
      0004BA BE FF 01         [24]  729 	cjne	r6,#0xff,00136$
      0004BD 1F               [12]  730 	dec	r7
      0004BE                        731 00136$:
      0004BE 80 E0            [24]  732 	sjmp	00104$
      0004C0                        733 00106$:
                                    734 ;	lib/Delay.c:68: clr_TR1;                               			//Stop Timer1
                                    735 ;	assignBit
      0004C0 C2 8E            [12]  736 	clr	_TR1
                                    737 ;	lib/Delay.c:69: }
      0004C2 22               [24]  738 	ret
                                    739 ;------------------------------------------------------------
                                    ...
                                    747 ;	-----------------------------------------
      0004C3                        748 _Timer2_Delay500us:
      0004C3 AC 82            [24]  749 	mov	r4,dpl
      0004C5 AD 83            [24]  750 	mov	r5,dph
      0004C7 AE F0            [24]  751 	mov	r6,b
      0004C9 FF               [12]  752 	mov	r7,a
                                    753 ;	lib/Delay.c:73: clr_T2DIV2;																	//Timer2 Clock = Fsys/4 
      0004CA 53 C9 BF         [24]  754 	anl	_T2MOD,#0xbf
                                    755 ;	lib/Delay.c:74: clr_T2DIV1;
      0004CD 53 C9 DF         [24]  756 	anl	_T2MOD,#0xdf
                                    757 ;	lib/Delay.c:75: set_T2DIV0;
      0004D0 43 C9 10         [24]  758 	orl	_T2MOD,#0x10
                                    759 ;	lib/Delay.c:76: set_TR2;                                		//Start Timer2
                                    760 ;	assignBit
      0004D3 D2 CA            [12]  761 	setb	_TR2
                                    762 ;	lib/Delay.c:77: while (u32CNT != 0)
      0004D5                        763 00104$:
      0004D5 EC               [12]  764 	mov	a,r4
      0004D6 4D               [12]  765 	orl	a,r5
      0004D7 4E               [12]  766 	orl	a,r6
      0004D8 4F               [12]  767 	orl	a,r7
      0004D9 60 1A            [24]  768 	jz	00106$
                                    769 ;	lib/Delay.c:79: TL2 = LOBYTE(TIMER_DIV4_VALUE_500us);		//Find  define in "Function_define.h" "TIMER VALUE"
      0004DB 75 CC 30         [24]  770 	mov	_TL2,#0x30
                                    771 ;	lib/Delay.c:80: TH2 = HIBYTE(TIMER_DIV4_VALUE_500us);
      0004DE 75 CD F8         [24]  772 	mov	_TH2,#0xf8
                                    773 ;	lib/Delay.c:81: while (TF2 != 1);                   		//Check Timer2 Time-Out Flag
      0004E1                        774 00101$:
                                    775 ;	lib/Delay.c:82: clr_TF2;
                                    776 ;	assignBit
      0004E1 10 CF 02         [24]  777 	jbc	_TF2,00135$
      0004E4 80 FB            [24]  778 	sjmp	00101$
      0004E6                        779 00135$:
                                    780 ;	lib/Delay.c:83: u32CNT --;
      0004E6 1C               [12]  781 	dec	r4
      0004E7 BC FF 09         [24]  782 	cjne	r4,#0xff,00136$
      0004EA 1D               [12]  783 	dec	r5
      0004EB BD FF 05         [24]  784 	cjne	r5,#0xff,00136$
      0004EE 1E               [12]  785 	dec	r6
      0004EF BE FF 01         [24]  786 	cjne	r6,#0xff,00136$
      0004F2 1F               [12]  787 	dec	r7
      0004F3                        788 00136$:
      0004F3 80 E0            [24]  789 	sjmp	00104$
      0004F5                        790 00106$:
                                    791 ;	lib/Delay.c:85: clr_TR2;                                		//Stop Timer2
                                    792 ;	assignBit
      0004F5 C2 CA            [12]  793 	clr	_TR2
                                    794 ;	lib/Delay.c:86: }
      0004F7 22               [24]  795 	ret
                                    796 ;------------------------------------------------------------
                                    ...
                                    804 ;	-----------------------------------------
      0004F8                        805 _Timer3_Delay100ms:
      0004F8 AC 82            [24]  806 	mov	r4,dpl
      0004FA AD 83            [24]  807 	mov	r5,dph
      0004FC AE F0            [24]  808 	mov	r6,b
      0004FE FF               [12]  809 	mov	r7,a
                                    810 ;	lib/Delay.c:90: T3CON = 0x07;                           		//Timer3 Clock = Fsys/128
      0004FF 75 C4 07         [24]  811 	mov	_T3CON,#0x07
                                    812 ;	lib/Delay.c:91: set_TR3;                                		//Trigger Timer3
      000502 43 C4 08         [24]  813 	orl	_T3CON,#0x08
                                    814 ;	lib/Delay.c:92: while (u32CNT != 0)
      000505                        815 00104$:
      000505 EC               [12]  816 	mov	a,r4
      000506 4D               [12]  817 	orl	a,r5
      000507 4E               [12]  818 	orl	a,r6
      000508 4F               [12]  819 	orl	a,r7
      000509 60 20            [24]  820 	jz	00106$
                                    821 ;	lib/Delay.c:94: RL3 = LOBYTE(TIMER_DIV128_VALUE_100ms); //Find  define in "Function_define.h" "TIMER VALUE"
      00050B 75 C5 2C         [24]  822 	mov	_RL3,#0x2c
                                    823 ;	lib/Delay.c:95: RH3 = HIBYTE(TIMER_DIV128_VALUE_100ms);
      00050E 75 C6 CF         [24]  824 	mov	_RH3,#0xcf
                                    825 ;	lib/Delay.c:96: while ((T3CON&SET_BIT4) != SET_BIT4);		//Check Timer3 Time-Out Flag
      000511                        826 00101$:
      000511 AB C4            [24]  827 	mov	r3,_T3CON
      000513 53 03 10         [24]  828 	anl	ar3,#0x10
      000516 BB 10 F8         [24]  829 	cjne	r3,#0x10,00101$
                                    830 ;	lib/Delay.c:97: clr_TF3;
      000519 53 C4 EF         [24]  831 	anl	_T3CON,#0xef
                                    832 ;	lib/Delay.c:98: u32CNT --;
      00051C 1C               [12]  833 	dec	r4
      00051D BC FF 09         [24]  834 	cjne	r4,#0xff,00137$
      000520 1D               [12]  835 	dec	r5
      000521 BD FF 05         [24]  836 	cjne	r5,#0xff,00137$
      000524 1E               [12]  837 	dec	r6
      000525 BE FF 01         [24]  838 	cjne	r6,#0xff,00137$
      000528 1F               [12]  839 	dec	r7
      000529                        840 00137$:
      000529 80 DA            [24]  841 	sjmp	00104$
      00052B                        842 00106$:
                                    843 ;	lib/Delay.c:100: clr_TR3;                                		//Stop Timer3
      00052B 53 C4 F7         [24]  844 	anl	_T3CON,#0xf7
                                    845 ;	lib/Delay.c:101: }
      00052E 22               [24]  846 	ret
                                    847 ;------------------------------------------------------------
                                    848 ;Allocation info for local variables in function 'Timer3_Delay10us'
                                    849 ;------------------------------------------------------------
                                    850 ;u32CNT        Allocated to registers r4 r5 r6 r7 
                                    851 ;------------------------------------------------------------
                                    852 ;	lib/Delay.c:103: void Timer3_Delay10us(UINT32 u32CNT)
                                    853 ;	-----------------------------------------
                                    854 ;	 function Timer3_Delay10us
                                    855 ;	-----------------------------------------
      00052F                        856 _Timer3_Delay10us:
      00052F AC 82            [24]  857 	mov	r4,dpl
      000531 AD 83            [24]  858 	mov	r5,dph
      000533 AE F0            [24]  859 	mov	r6,b
      000535 FF               [12]  860 	mov	r7,a
                                    861 ;	lib/Delay.c:105: T3CON = 0x07;                           		//Timer3 Clock = Fsys/128
      000536 75 C4 07         [24]  862 	mov	_T3CON,#0x07
                                    863 ;	lib/Delay.c:106: set_TR3;                                		//Trigger Timer3
      000539 43 C4 08         [24]  864 	orl	_T3CON,#0x08
                                    865 ;	lib/Delay.c:107: while (u32CNT != 0)
      00053C                        866 00104$:
      00053C EC               [12]  867 	mov	a,r4
      00053D 4D               [12]  868 	orl	a,r5
      00053E 4E               [12]  869 	orl	a,r6
      00053F 4F               [12]  870 	orl	a,r7
      000540 60 20            [24]  871 	jz	00106$
                                    872 ;	lib/Delay.c:109: RL3 = LOBYTE(TIMER_DIV4_VALUE_10us); //Find  define in "Function_define.h" "TIMER VALUE"
      000542 75 C5 D8         [24]  873 	mov	_RL3,#0xd8
                                    874 ;	lib/Delay.c:110: RH3 = HIBYTE(TIMER_DIV4_VALUE_10us);
      000545 75 C6 FF         [24]  875 	mov	_RH3,#0xff
                                    876 ;	lib/Delay.c:111: while ((T3CON&SET_BIT4) != SET_BIT4);		//Check Timer3 Time-Out Flag
      000548                        877 00101$:
      000548 AB C4            [24]  878 	mov	r3,_T3CON
      00054A 53 03 10         [24]  879 	anl	ar3,#0x10
      00054D BB 10 F8         [24]  880 	cjne	r3,#0x10,00101$
                                    881 ;	lib/Delay.c:112: clr_TF3;
      000550 53 C4 EF         [24]  882 	anl	_T3CON,#0xef
                                    883 ;	lib/Delay.c:113: u32CNT --;
      000553 1C               [12]  884 	dec	r4
      000554 BC FF 09         [24]  885 	cjne	r4,#0xff,00137$
      000557 1D               [12]  886 	dec	r5
      000558 BD FF 05         [24]  887 	cjne	r5,#0xff,00137$
      00055B 1E               [12]  888 	dec	r6
      00055C BE FF 01         [24]  889 	cjne	r6,#0xff,00137$
      00055F 1F               [12]  890 	dec	r7
      000560                        891 00137$:
      000560 80 DA            [24]  892 	sjmp	00104$
      000562                        893 00106$:
                                    894 ;	lib/Delay.c:115: clr_TR3;                                		//Stop Timer3
      000562 53 C4 F7         [24]  895 	anl	_T3CON,#0xf7
                                    896 ;	lib/Delay.c:116: }
      000565 22               [24]  897 	ret
                                    898 	.area CSEG    (CODE)
                                    899 	.area CONST   (CODE)
