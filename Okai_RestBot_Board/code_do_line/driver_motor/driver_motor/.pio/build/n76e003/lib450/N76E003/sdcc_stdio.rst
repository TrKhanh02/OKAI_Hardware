      ...
      000000                        493 	.ds 8
                                    ...
                                    556 	.area CSEG    (CODE)
                                    557 ;------------------------------------------------------------
                                    558 ;Allocation info for local variables in function 'putchar'
                                    559 ;------------------------------------------------------------
                                    560 ;c                         Allocated to registers r6 r7 
                                    561 ;------------------------------------------------------------
                                    562 ;	lib\N76E003\sdcc_stdio.c:5: int putchar (int c) {
                                    563 ;	-----------------------------------------
                                    564 ;	 function putchar
                                    565 ;	-----------------------------------------
      000904                        566 _putchar:
                           000007   567 	ar7 = 0x07
                           000006   568 	ar6 = 0x06
                           ...
                           000001   573 	ar1 = 0x01
                           000000   574 	ar0 = 0x00
      000904 AE 82            [24]  575 	mov	r6, dpl
      000906 AF 83            [24]  576 	mov	r7, dph
                                    577 ;	lib\N76E003\sdcc_stdio.c:6: while (!TI);
      000908                        578 00101$:
                                    579 ;	lib\N76E003\sdcc_stdio.c:7: TI = 0;
                                    580 ;	assignBit
      000908 10 99 02         [24]  581 	jbc	_TI,00118$
      00090B 80 FB            [24]  582 	sjmp	00101$
      00090D                        583 00118$:
                                    584 ;	lib\N76E003\sdcc_stdio.c:8: SBUF = c;
      00090D 8E 99            [24]  585 	mov	_SBUF,r6
                                    586 ;	lib\N76E003\sdcc_stdio.c:9: return c;
      00090F 8E 82            [24]  587 	mov	dpl, r6
      000911 8F 83            [24]  588 	mov	dph, r7
                                    589 ;	lib\N76E003\sdcc_stdio.c:10: }
      000913 22               [24]  590 	ret
                                    591 ;------------------------------------------------------------
                                    592 ;Allocation info for local variables in function 'getchar'
                                    593 ;------------------------------------------------------------
                                    594 ;	lib\N76E003\sdcc_stdio.c:12: int getchar (void) {
                                    595 ;	-----------------------------------------
                                    596 ;	 function getchar
                                    597 ;	-----------------------------------------
      000914                        598 _getchar:
                                    599 ;	lib\N76E003\sdcc_stdio.c:13: while (!RI);
      000914                        600 00101$:
                                    601 ;	lib\N76E003\sdcc_stdio.c:14: RI = 0;
                                    602 ;	assignBit
      000914 10 98 02         [24]  603 	jbc	_RI,00118$
      000917 80 FB            [24]  604 	sjmp	00101$
      000919                        605 00118$:
                                    606 ;	lib\N76E003\sdcc_stdio.c:15: return SBUF;
      000919 AE 99            [24]  607 	mov	r6,_SBUF
      00091B 7F 00            [12]  608 	mov	r7,#0x00
      00091D 8E 82            [24]  609 	mov	dpl, r6
      00091F 8F 83            [24]  610 	mov	dph, r7
                                    611 ;	lib\N76E003\sdcc_stdio.c:16: }
      000921 22               [24]  612 	ret
                                    613 	.area CSEG    (CODE)
                                    614 	.area CONST   (CODE)
                                    615 	.area XINIT   (CODE)
