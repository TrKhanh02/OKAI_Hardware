...
#define ALL_GPIO_PUSHPULL_MODE    			do{P0M1=0;P0M2=0xFF;P1M1=0;P1M2=0xFF;P3M1=0;P3M2=0xFF;}while(0)
...
#if defined(FOSC_166000)
    #define PWM_FSYS       16600000UL
#elif defined(FOSC_160000)
    #define PWM_FSYS       16000000UL
#else
    #define PWM_FSYS       16000000UL   // fallback
#endif

#define PWM_FSYS_DIV_1     (PWM_FSYS / 1UL)
#define PWM_FSYS_DIV_2     (PWM_FSYS / 2UL)
#define PWM_FSYS_DIV_4     (PWM_FSYS / 4UL)
#define PWM_FSYS_DIV_8     (PWM_FSYS / 8UL)
#define PWM_FSYS_DIV_16    (PWM_FSYS / 16UL)
#define PWM_FSYS_DIV_32    (PWM_FSYS / 32UL)
#define PWM_FSYS_DIV_64    (PWM_FSYS / 64UL)
#define PWM_FSYS_DIV_128   (PWM_FSYS / 128UL)
...
#define ENABLE_ADC                        	set_ADCEN
#define DISABLE_ADC                      	clr_ADCEN
...
#define Enable_ADC_BandGap					do{DISABLE_ADC;ADCCON0&=0xF0;ADCCON0|=0x08;ADCCON0&=0xF8;ENABLE_ADC;}while(0)																						//Band-gap 1.22V
