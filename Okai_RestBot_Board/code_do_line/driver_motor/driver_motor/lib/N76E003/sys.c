...
{
    uint8_t __data hircmap0,hircmap1,DIDhighbyte, DIDlowbyte, BYTE_TMP;
...
void FsysSelect(uint8_t u8FsysMode)
{
  switch (u8FsysMode)
  {
    ...
    case FSYS_LIRC:
        ...
        clr_HIRCEN;                        // Disable HIRC if needed 
    break;
    ...
    case FSYS_OSCIN_P30:
        ...
        clr_HIRCEN;                        //step5: disable HIRC if needed 
    break;
  }
}
...
void ClockEnable(uint8_t u8FsysMode)
{
  switch (u8FsysMode)
  {
    /***** HIRC enable part ******/
    case FSYS_HIRC:
        set_HIRCEN;                        //step1: Enable extnal clock source.
